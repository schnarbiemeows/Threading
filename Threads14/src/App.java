...
public class App {
	...
	public static void main(String[] args) throws InterruptedException {
		// tutorial 14: interrupting Threads
		// implementing thread interruption capability is a 2 part process:
		// 1. you need to check for interrupted inside the thread method
		// 2. you need to create your thread interruption condition in the method
